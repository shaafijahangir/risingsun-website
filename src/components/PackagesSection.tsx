...
const TravelPackage = ({
  ...
  return (
    <Card className="overflow-hidden border-0 shadow-card transition-all duration-300 hover:-translate-y-2 hover:shadow-lift cursor-pointer h-full">
      ...
      <CardContent className="p-6">
        ...
        <div className="mb-6">
          <div className="font-medium mb-2">{t("packages.includes")}</div>
        ...
        <Button asChild className="w-full bg-thai-gold hover:bg-thai-gold/90 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
...
const PackagesSection = () => {
  ...
  return (
    <section ref={ref} id="packages" className="section-padding bg-brand-offwhite">
      <div className="container-custom">
        ...
        <div className={`text-center mt-12 anim-fade-up ${isVisible ? "in-view" : ""}`}
             style={{ transitionDelay: '520ms' }}>
          <p className="text-muted-foreground mb-4">
            {t("packages.customText")}
          </p>
          <Button asChild className="bg-brand-navy hover:bg-brand-navy/90 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
